...
const { placeOrder, getLossIncomes, cleanUpOrphanedOrders, placeOrderTest, placeOrderTestNew, fetchAllPositions, fetchOpenOrders, cancelOrder, setupStopLossOrder, setupTakeProfitOrder } = require('../binance/trade');
